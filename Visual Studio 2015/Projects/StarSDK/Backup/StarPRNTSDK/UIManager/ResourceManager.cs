...
namespace StarPRNTSDK
{
    public class ResourceManager
    {
        ...
        public string ScaleSamplePageTitle
        {
            get
            {
                return Properties.Resources.ScaleSamplePageTitle;
            }
        }

        public string ScaleExtSamlePageTitle
        {
            get
            {
                return Properties.Resources.ScaleExtSamlePageTitle;
            }
        }
        ...
        public string PrinterDriverWithScaleSamplePageTitle
        {
            get
            {
                return Properties.Resources.PrinterDriverWithScaleSamplePageTitle;
            }
        }
