        ...
        public static byte[] CreateGraphicPattern(DisplayFunctionManager.GraphicPattern pattern)
        {
            ...
            switch (pattern)
            {
                ...
                case DisplayFunctionManager.GraphicPattern.Pattern2:
                    using (var stream = Properties.Resources.display_image_2)
                    {
                        bitmap = new Bitmap(stream);
                    }
                    break;

                case DisplayFunctionManager.GraphicPattern.Pattern3:
                    using (var stream = Properties.Resources.display_image_3)
                    {
                        bitmap = new Bitmap(stream);
                    }
                    break;

                case DisplayFunctionManager.GraphicPattern.Pattern4:
                    using (var stream = Properties.Resources.display_image_4)
                    {
                        bitmap = new Bitmap(stream);
                    }
                    break;
