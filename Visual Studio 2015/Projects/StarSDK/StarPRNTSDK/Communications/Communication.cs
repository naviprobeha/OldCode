...
namespace StarPRNTSDK
{
    public static class Communication
    {
        ...
        public static CommunicationResult SendCommands(byte[] commands, string portName, string portSettings, int timeout)
        {
            ...
            System.IO.StreamWriter streamWriter = new System.IO.StreamWriter("C:\\temp\\star_output.txt");
            streamWriter.WriteLine(System.Text.Encoding.Default.GetString(commands));
            streamWriter.Flush();
            streamWriter.Close();
        ...
        public static CommunicationResult SendCommandsDoNotCheckCondition(byte[] commands, string portName, string portSettings, int timeout)
        {
            ...
            System.IO.StreamWriter streamWriter = new System.IO.StreamWriter("C:\\temp\\star_output.txt");
            streamWriter.WriteLine(commands);
            streamWriter.Flush();
            streamWriter.Close();
