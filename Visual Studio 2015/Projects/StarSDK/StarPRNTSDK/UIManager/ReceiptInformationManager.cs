...
namespace StarPRNTSDK
{
    public class ReceiptInformationManager : DependencyObject
    {
        ...
        public PaperSize.PaperSizeType PaperSizeType
        {
            get
            {
        ...
        public string DescriptionWithRotation
        {
            get
            {
                return CreateDescriptionWithRotation();
            }
        }
        ...
        private string CreateDescription()
        {
            ...
            switch (Type)
            {
                ...
                case ReceiptType.RasterBothScale:
                    description = Language.Code + " " + PaperSize.ScaledCode + " " + GetTypeDescription();
                    break;

                case ReceiptType.RasterCoupon:
                case ReceiptType.RasterCouponRotation90:
                    description = Language.Code + " " + GetTypeDescription();
                    break;

                case ReceiptType.TextLabel:
                    if(PaperSizeType == PaperSize.PaperSizeType.Unknown)
                    {
                        description = Language.Code + " " + GetTypeDescription();
                    }
                    else
                    {
                        description = Language.Code + " " + PaperSize.Code + " " + GetTypeDescription();
                    }
                    break;
        ...
        private string CreateDescriptionWithRotation()
        {
            return CreateDescription() + " (Rotation" + GetRotationDescription() + ")";
        }
