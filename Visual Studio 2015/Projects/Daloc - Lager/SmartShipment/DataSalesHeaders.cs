		...
		public XmlElement toDOM(XmlDocument xmlDocumentContext)
		{
			...
			while(dataReader.Read())
			{
				try
				{
                    ...
                    fieldElement = xmlDocumentContext.CreateElement("F");
                    fieldElement.SetAttribute("NO", "84");
                    fieldElement.AppendChild(xmlDocumentContext.CreateTextNode(StringConverter.convertToAscii((string)dataReader.GetValue(15))));
                    recordElement.AppendChild(fieldElement);
					...
					fieldElement.AppendChild(xmlDocumentContext.CreateTextNode(dataReader.GetValue(19).ToString()));
					recordElement.AppendChild(fieldElement);
