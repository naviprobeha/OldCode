		...
		public XmlElement toDOM(XmlDocument xmlDocumentContext)
		{
			...
			while(dataReader.Read())
			{
				try
				{
					...
					fieldElement.AppendChild(xmlDocumentContext.CreateTextNode((dataReader.GetFloat(7) / (1-(dataReader.GetFloat(5)/100))).ToString().Replace(".", ","))); // A-pris
					recordElement.AppendChild(fieldElement);

					fieldElement = xmlDocumentContext.CreateElement("F");
					fieldElement.SetAttribute("NO", "27");
					fieldElement.AppendChild(xmlDocumentContext.CreateTextNode(dataReader.GetFloat(5).ToString().Replace(".", ","))); // Rabatt
					recordElement.AppendChild(fieldElement);
					...
					fieldElement = xmlDocumentContext.CreateElement("F");
					fieldElement.SetAttribute("NO", "27");
					fieldElement.AppendChild(xmlDocumentContext.CreateTextNode(""+dataReader.GetFloat(5)));
					recordElement.AppendChild(fieldElement);
					*/
					...
					fieldElement.AppendChild(xmlDocumentContext.CreateTextNode(dataReader.GetFloat(7).ToString().Replace(".", ","))); // Apris-netto
					recordElement.AppendChild(fieldElement);
