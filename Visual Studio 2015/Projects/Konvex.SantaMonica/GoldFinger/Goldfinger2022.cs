    ...
    public class Goldfinger2022 : IGoldfinger, Logger
    {
        ...
        public int reportStatus(string agentCode, int rt90x, int rt90y, float heading, float speed, float height, int status, string userName, int tripMeter)
        {
            ...
            */
            ...
            string response = makeApiCall("agentApi/reportStatus/" + agentCode, "POST", statusObject.ToString(), agentCode);
        ...
        public void ackSynchRecord(string agentCode, int[] synchEntryNoList)
        {
            ...
            makeApiCall("agentApi/ackSyncRecord", "POST", array.ToString(), agentCode);
        ...
        public void assignShipOrder(string agentCode, string no, string newAgentCode)
        {
            ...
            makeApiCall("agentApi/assignShipOrder/"+no, "POST", assignAgentObject.ToString(), agentCode);
        ...
        public void createOrder(string agentCode, OrderHeader fromOrderHeader)
        {
            ...
            makeApiCall("agentApi/createOrder/" + agentCode, "POST", orderObject.ToString(), agentCode);
        ...
        public void createShipment(string agentCode, DataObjects.ShipmentHeader fromShipmentHeader)
        {
            ...
            makeApiCall("agentApi/createShipment/"+agentCode, "POST", shipmentJObject.ToString(), agentCode);
        ...
        public SynchEntryCollection getSynchRecord(string agentCode)
        {
            ...
            string content = makeApiCall("agentApi/getSyncRecords/" + agentCode, "GET", "", agentCode);
        ...
        public void setMessageStatus(string agentCode, int messageEntryNo, int status)
        {
            ...
            makeApiCall("agentApi/setMessageStatus/" + messageEntryNo, "POST", statusObject.ToString(), agentCode);
        ...
        public void setShipOrderStatus(string agentCode, string no, int status, int positionX, int positionY, DateTime shipTime, string comment, int distance)
        {
            ...
            makeApiCall("agentApi/setShipOrderStatus/" + no, "POST", statusObject.ToString(), agentCode);
        }
        ...
        {
            string content = makeApiCall("agentApi/getRoutes/" + agentCode + "?shipmentDate=" + shipDate.ToString("yyyy-MM-dd"), "GET", "", agentCode);
        ...
        {
            string content = makeApiCall("agentApi/getLineOrders/" + agentCode + "?routeEntryNo=" + lineJournalNo, "GET", "", agentCode);
        ...
        {
            makeApiCall("agentApi/reportRoute/" + agentCode, "POST", lineJournal.toJsonObject(), agentCode);
            return;
        ...
        public void setLineOrderContainers(string agentCode, string no, List<string> containerStringList)
        {
            ...
            makeApiCall("agentApi/setLineOrderContainers/" + agentCode + "?lineOrderEntryNo=" + no, "POST", containerArray.ToString(), agentCode);
            return;
        ...
        {
            makeApiCall("agentApi/setLineOrderStatus/" + agentCode + "?entryNo=" + no + "&status=" + status + "&positionX=" + positionX + "&positionY=" + positionY + "&shipmentDateTime=" + shipTime.ToString("yyyy-MM-dd HH:mm:ss") + "&loadWaitTime=" + loadWaitTime + "&loadWaitReason=" + loadWaitReason, "POST", "{}", agentCode);
            return;
        }
        ...
        private string makeApiCall(string endpoint, string method, string payload, string agentCode)
        {
            if (agentCode == "OOW")
            {
                return makeTestApiCall(endpoint, method, payload);
            }
            if (agentCode == "AAA")
            {
                return makeTestApiCall(endpoint, method, payload);
