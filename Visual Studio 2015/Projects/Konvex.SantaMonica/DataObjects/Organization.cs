...
namespace Konvex.SmartShipping.DataObjects
{
    public class Organization
    {
        ...
        public static Organization fromJsonObject(JObject jsonObject)
        {
            Organization entry = new Organization();
            entry.no = (string)jsonObject["code"];
            ...
            entry.contactName = (string)jsonObject["contactName"];
            entry.stopFee = (decimal)jsonObject["stopFee"];
