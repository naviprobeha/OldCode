<%@ Page language="c#" Codebehind="consumerCapacity_generate.aspx.cs" AutoEventWireup="false" Inherits="WebAdmin.consumerCapacity_generate" %>
...
<HTML>
	<HEAD>
		...
		function goBack()
		{
			document.location.href='consumerCapacity.aspx?consumerNo=<%= currentConsumer.no %>';		
		}
	...
	<body MS_POSITIONING="GridLayout" topmargin="10">
		...
		<form id="thisform" action="consumerCapacity_generate.aspx" method="post" runat="server">
					...
					<td>
						<table cellspacing="1" cellpadding="2" border="0" width="100%" class="innerFrame">
							...
							<tr>
								...
								<td class="interaction2" height="20">&nbsp;&nbsp;<input type="text" name="capacity" class="Textfield" size="5" maxlength="5" value=""> ton/h</td>
							</tr>
						</table>
					</td>
				</tr>
