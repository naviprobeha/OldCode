<%@ Page language="c#" Codebehind="orders_id.aspx.cs" AutoEventWireup="false" Inherits="Navipro.SantaMonica.WebAdmin.orders_id" %>
...
<HTML>
	...
	<body MS_POSITIONING="GridLayout" topmargin="10" onload="document.thisform.id.focus()">
		...
		<form id="thisform" action="orders_id.aspx" method="post" runat="server">
			<input type="hidden" name="command" value="addId">
					...
					<td>
						<table cellspacing="1" cellpadding="2" border="0" width="100%" class="innerFrame">
							...
							<tr>
								...
								<td class="jobDescription" valign="top" align="right"><%= currentShipOrderLine.amount %> kr</td>
								<td class="jobDescription" valign="top" align="right"><%= currentShipOrderLine.connectionQuantity %></td>
								<td class="jobDescription" valign="top" align="right"><%= currentShipOrderLine.connectionAmount %> kr</td>
						...
						<table cellspacing="1" cellpadding="2" border="0" width="100%" class="innerFrame">
							...
							%>							
							<tr>
								<td class="jobDescription" valign="top" align="left" width="80%"><input type="text" name="id" class="Textfield" size="40" maxlength="100">&nbsp;<input type="button" class="Button" name="se" value="SE-nr" onclick="document.thisform.id.value='SE <%= currentShipOrder.productionSite %>-'+document.thisform.id.value;"></td>
								<td class="jobDescription" valign="top" align="center"><input type="checkbox" name="bse"></td>
								<td class="jobDescription" valign="top" align="center"><input type="checkbox" name="obd"></td>
								<td class="jobDescription" valign="top" align="center" colspan="2"><input type="submit" value="Lägg till" class="button"></td>
							</tr>
