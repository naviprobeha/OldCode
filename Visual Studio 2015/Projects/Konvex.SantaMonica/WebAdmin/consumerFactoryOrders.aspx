<%@ Page language="c#" Codebehind="consumerFactoryOrders.aspx.cs" AutoEventWireup="false" Inherits="WebAdmin.consumerFactoryOrders" %>
...
<HTML>
	...
	<body MS_POSITIONING="GridLayout" topmargin="10" onload="setTimeout('document.thisform.submit()', 600000)">
		...
		<input type="hidden" name="command" value="">
			<table cellspacing="2" cellpadding="2" border="0" width="100%" class="frame">
				...
				<tr>
					...
					</select>&nbsp;Framåt i tiden: <input type="checkbox" name="forward" onclick="changeShipDate()" <% if (Session["forward"].ToString() == "1") Response.Write("checked"); %>>&nbsp;<input type="button" value="Idag" onclick="gotoToday()" class="Button"></td>
				</tr>
				<tr>
					<td>
						<table cellspacing="1" cellpadding="2" border="0" width="100%" class="innerFrame">
							...
							<%
								...
								while (i < activeFactoryOrders.Tables[0].Rows.Count)
								{
									...
									string quantity = factoryOrder.quantity.ToString();
									if (factoryOrder.realQuantity > 0) quantity = factoryOrder.realQuantity.ToString();
									...
									<tr>
										...
										<td class="jobDescription" valign="top" style="<%= bgStyle %>" align="right"><%= quantity %></td>
