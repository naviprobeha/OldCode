<%@ Page language="c#" Codebehind="consumerInventoryView.aspx.cs" AutoEventWireup="false" Inherits="WebAdmin.consumerInventoryView" %>
...
<HTML>
	...
	function changeYear()
	{
		document.thisform.action = "consumerInventoryView.aspx";
	...
	<body MS_POSITIONING="GridLayout" topmargin="10" onload="setTimeout('changeWeek()', 600000)">
		...
		<form id="thisform" action="consumerInventoryView.aspx" method="post" runat="server">
		<input type="hidden" name="command" value="">
			<table cellspacing="2" cellpadding="2" border="0" width="100%" class="frame">
				...
				<tr>
					<td class="activityName">Lager</td>
				</tr>
				<tr>
					<td class="" width="95%">Värmeverk: <b><%= currentConsumer.name %></b>&nbsp;År:&nbsp;<% WebAdmin.HTMLHelper.createYearPicker("currentYear", currentYear); %>&nbsp;Vecka:&nbsp;<% WebAdmin.HTMLHelper.createWeekPicker("currentWeek", currentYear, currentWeek); %>&nbsp;
									...
									%>		
										<table cellspacing="1" cellpadding="2" border="0" width="100%" class="innerFrame">
											...
											<tr>
												...
												<td class="jobDescription" width="100" style="font-weight: bold;" align="right">&nbsp;</td>
											</tr>
											<%
												int hour = 0;
												while (hour < 24)
												{
													...
													System.Collections.ArrayList factoryOrderList = consumerInventoryOrders.getFactoryOrders(database, currentConsumer.no, hourDateTime);																									
													if (factoryOrderList.Count == 0)
													{
															
															factoryOrderList = factoryOrders.getConsumerList(database, currentConsumer.no, hourDateTime);
													}													
													...
													while (z < loop)
													{
														...
														<td class="jobDescription">
															...
															<tr>
																...
																<td align="right">&nbsp;<% if (factoryOrderEntryNo != "") Response.Write("<a href=\"factoryOrders_view.aspx?factoryOrderNo="+factoryOrderEntryNo+"\"><img src=\"images/button_assist.gif\" border=\"0\"></a>"); %></td>																
															</tr>
															</table>
														</td>
														...
														if (z == 0)
														{
															...
															<td class="jobDescription" rowspan="<%= loop %>" valign="top" align="center"><a href="consumerInventory_modify.aspx?consumerNo=<%= currentConsumer.no %>&date=<%= firstDay.AddDays(weekDay).ToString("yyyy-MM-dd") %>&hour=<%= hourDateTime.ToString("HH") %>"><img src="images/button_assist.gif" border="0" width="12" height="13"></a></td>													
															<%
														}												
