<%@ Page language="c#" Codebehind="status_nonLoadedContainers.aspx.cs" AutoEventWireup="false" Inherits="WebAdmin.status_nonLoadedContainers" %>
...
<HTML>
	...
	function changeShipDate()
	{
		...
		document.thisform.action = "status_nonLoadedContainers.aspx";
	...
	<body MS_POSITIONING="GridLayout" topmargin="10" onload="setTimeout('document.thisform.submit()', 60000)">
		...
		<input type="hidden" name="command" value="">
			<table cellspacing="2" cellpadding="2" border="0" width="100%" class="frame">
				...
				<tr>
					<td class="activityName">Ej lastade/lossade containers</td>
				</tr>
				<tr>
					...
					</select>&nbsp;<input type="button" value="Idag" onclick="gotoToday()" class="Button">&nbsp;Typ:&nbsp;<select name="type" onchange="changeShipDate()" class="Textfield"><option value="0" <% if (type==0) Response.Write("selected"); %>>Ej lastade</option><option value="1" <% if (type==1) Response.Write("selected"); %>>Ej lossade</option></select></td>
				</tr>
				<tr>
					<td>
							...
							<%
								...
								while (i < containerDataSet.Tables[0].Rows.Count)
								{
									...
									<tr>
										...
										<td class="jobDescription" valign="top" style="<%= bgStyle %>"><%= lineOrderContainer.weight.ToString("0") %> kg</td>
