...
namespace WebAdmin
{
	...
	/// </summary>
	public class callLog : System.Web.UI.Page
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			if (!currentOperator.checkSecurity(database, currentOrganization, "callLog.aspx"))
			{
				Response.Redirect("default.htm");				
			}
			...
			{
				phoneLogDataSet = phoneLogEntries.getDataSet(database, currentOperator.userId, fromDate, toDate);
			}
			else
			{
				phoneLogDataSet = phoneLogEntries.getDataSet(database, currentOperator.userId, fromDate, toDate, int.Parse(Request["callType"]));
			}
