<%@ Page language="c#" Codebehind="lineorders.aspx.cs" AutoEventWireup="false" Inherits="WebAdmin.lineorders" %>
...
<HTML>
	...
	function changeShipDate()
	{
		...
		document.thisform.action = "lineorders.aspx";
		...
		<input type="hidden" name="command" value="">
			<table cellspacing="2" cellpadding="2" border="0" width="100%" class="frame">
				...
				<tr>
					...
					</select>&nbsp;<input type="button" value="Idag" onclick="gotoToday()" class="Button">&nbsp;<% if (currentOrganization.allowLineOrderSupervision) { %>&nbsp;<input type="button" value="<% if (showInfo) Response.Write("Dölj info"); else Response.Write("Visa info"); %>" class="button" onclick="toggleInfo()">&nbsp;<input type="button" value="Ny order" class="button" onclick="document.location.href='shippingCustomers.aspx';"><% } %></td>
				</tr>
				<tr>
					<td>
						<table cellspacing="1" cellpadding="2" border="0" width="100%" class="innerFrame">
							...
							<%
								...
								while (i < activeLineOrders.Tables[0].Rows.Count)
								{
									...
									string redStyle = "";
									if (lineOrder.creationDate.AddDays(3) < DateTime.Today) redStyle = "color: red;";
									...
									if (showInfo)
									{
										...
										<tr>
											...
											<td class="jobDescription" rowspan="2" valign="top" style="<%= bgStyle %>"><%= lineOrder.entryNo.ToString() %></td>
											...
											<td class="jobDescription" valign="top" style="<%= bgStyle+redStyle %>"><%= lineOrder.creationDate.ToString("yyyy-MM-dd") %></td>
											...
											<td class="jobDescription" rowspan="2" valign="top" style="<%= bgStyle %>" nowrap>
												...
												while (k < containerDataSet.Tables[0].Rows.Count)
												{
													...
													if (lineOrderContainer.realWeight > 0) lineOrderContainer.weight = lineOrderContainer.realWeight;
													
													%><tr>
													<td class="jobDescription" style="<%= bgStyle+serviceStyle %>"><%= lineOrderContainer.containerNo+": "+categoryDesc+" ("+lineOrderContainer.weight+" kg)" %></td>
											...
											<td class="jobDescription" rowspan="2" valign="top" style="<%= bgStyle %>"><%= lineOrder.organizationNo %></td>
											<td class="jobDescription" rowspan="2" valign="top" style="<%= bgStyle %>">
												<table cellspacing="0" cellpadding="0" width="100%" border="0">
													<TR>
											...
											<td class="jobDescription" rowspan="2" valign="top" style="<%= bgStyle %>" align="center"><%= commentBooleanImg %></td>									
											<td class="jobDescription" rowspan="2" valign="top" style="<%= bgStyle %>"><%= statusText %></td>
											<td class="jobDescription" rowspan="2" valign="top" align="center" style="<%= bgStyle %>"><a href="lineorders_view.aspx?lineOrderNo=<%= lineOrder.entryNo.ToString() %>"><img src="images/button_assist.gif" border="0" width="12" height="13"></a></td>
											<td class="jobDescription" rowspan="2" valign="top" align="center" style="<%= bgStyle %>"><img src="images/<%= statusIcon %>" border="0" alt="<%= statusText %>"></td>
										</tr>
										<tr>
											<td class="jobDescription" colspan="6" style="<%= bgStyle %>"><%= lineOrder.comments %></td>
										</tr>
										<%
									}
									else
