...
namespace WebAdmin
{
	...
	/// </summary>
	public class factoryorders : System.Web.UI.Page
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			if (currentOrganization.allowLineOrderSupervision)
			{
				...
				{
					activeFactoryOrders = factoryOrders.getActiveFactoryDataSet(database, currentOperator.userId, Request["agent"], fromDate, toDate);			
					activeAgents = agentsClass.getDataSet(database, Agents.TYPE_TANK);
				}
			}
			else
