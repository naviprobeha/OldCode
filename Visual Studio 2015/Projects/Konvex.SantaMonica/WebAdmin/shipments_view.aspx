<%@ Page language="c#" Codebehind="shipments_view.aspx.cs" AutoEventWireup="false" Inherits="Navipro.SantaMonica.WebAdmin.shipments_view" %>
			...
			<table cellspacing="2" cellpadding="2" border="0" width="100%" class="frame">
				...
				<tr>
					<td>
						...
						<br>
						Samtliga nedanstående animaliska biprodukter hanteras som kat 1; endast för bortskaffande.
						<br>
						<table cellspacing="1" cellpadding="2" border="0" width="100%" class="innerFrame">
							<tr>
				...
				<tr>
					<td align="right"><input type="button" value="Skriv ut" onclick="window.open('shipments_print.aspx?no=<%= currentShipmentHeader.no %>', 'CtrlWindow', 'toolbar=yes,menubar=yes,location=yes,scrollbars=yes,resizable=yes');"
							class="Button">&nbsp;<input type="button" value="Tillbaka" onclick="document.location.href='shipments.aspx';"
							class="Button"></td>
				</tr>
			</table>
		</form>
