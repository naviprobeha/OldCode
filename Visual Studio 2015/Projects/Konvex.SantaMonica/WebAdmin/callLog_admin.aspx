<%@ Page language="c#" Codebehind="callLog_admin.aspx.cs" AutoEventWireup="false" Inherits="WebAdmin.callLog_admin" %>
		...
		<input type="hidden" name="command" value="">
			<table cellspacing="2" cellpadding="2" border="0" width="100%" class="frame">
				...
				<tr>
					...
					</select>&nbsp;<input type="button" value="Idag" onclick="gotoToday()" class="Button">&nbsp;Operatör:&nbsp;<select name="currentCallLogOperator" class="Textfield" onchange="document.thisform.submit()"><%
						
							int y = 0;
							while (y < callLogUserOperatorDataSet.Tables[0].Rows.Count)
							{
								string selected = "";
								if (callLogUserOperatorDataSet.Tables[0].Rows[y].ItemArray.GetValue(0).ToString() == currentCallLogOperator) selected = "selected";
								
								%><option value="<%= callLogUserOperatorDataSet.Tables[0].Rows[y].ItemArray.GetValue(0).ToString() %>" <%= selected %>><%= callLogUserOperatorDataSet.Tables[0].Rows[y].ItemArray.GetValue(1).ToString() %></option><%						
									...
									<tr>
										...
										<td class="jobDescription" valign="top" style="<%= bgStyle %>" align="center"><%
											...
											if (dataSet != null)
											{
												...
												{
													%><tr>
														<td class="jobDescription" width="50" style="<%= bgStyle %>"><%= dataSet.Tables[0].Rows[z].ItemArray.GetValue(0).ToString() %></td>
