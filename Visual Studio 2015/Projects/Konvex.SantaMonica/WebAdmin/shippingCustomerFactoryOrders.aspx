		...
		<input type="hidden" name="command" value="">
			<table cellspacing="2" cellpadding="2" border="0" width="100%" class="frame">
				...
				<tr>
					...
					</select>&nbsp;Framåt i tiden: <input type="checkbox" name="forward" onclick="changeShipDate()" <% if (Session["forward"].ToString() == "1") Response.Write("checked"); %>>&nbsp;<input type="button" value="Idag" onclick="gotoToday()" class="Button">&nbsp;<input type="button" value="Ny order" onclick="createOrder()" class="Button"></td>
				</tr>
				<tr>
					<td>
