...
namespace WebAdmin
{
	...
	/// </summary>
	public class factoryOrders_waittime : System.Web.UI.Page
	{
		protected Database database;
		protected FactoryOrders factoryOrders;
		protected DataSet factoryOrderDataSet;
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			{
				FactoryOrder factoryOrder = factoryOrders.getEntry(database, Request["factoryOrderNo"]);
				if (factoryOrder != null)
				{
					factoryOrder.factoryApproved = currentOperator.userId;
					factoryOrder.approvedBy = Request["approvedBy"];
					factoryOrder.approvedDateTime = DateTime.Now;
			...
			factoryOrderDataSet = factoryOrders.getUnConfirmedDataSet(database, currentFactory.no, firstDay, lastDay);
