<%@ Page language="c#" Codebehind="factoryOrders_admin.aspx.cs" AutoEventWireup="false" Inherits="WebAdmin.factoryorders_admin" %>
...
<HTML>
	...
	{
		document.thisform.command.value = "deleteAllOrders";
		document.thisform.submit();
		...
		<input type="hidden" name="command" value="">
			<table cellspacing="2" cellpadding="2" border="0" width="100%" class="frame">
				...
				<tr>
					...
					</select>&nbsp;<input type="button" value="Idag" onclick="gotoToday()" class="Button">&nbsp;<% if (currentOrganization.allowLineOrderSupervision) { %>&nbsp;<input type="button" value="Ny order" class="button" onclick="document.location.href='factoryOrders_modify.aspx';"><% } %>&nbsp;<input type="button" value="Radera alla order" class="button" onclick="deleteAllOrders();"></td>
				</tr>
				<tr>
					<td>
									...
									<tr>
										...
										<td class="jobDescription" valign="top" style="<%= bgStyle %>">
											<table cellspacing="0" cellpadding="0" width="100%" border="0">
												<TR>
													<td class="jobDescription" style="<%= bgStyle %>"><%= factoryOrder.agentCode %></td>
													<td align="right" style="<%= bgStyle %>"><a href="factoryOrders_assign.aspx?factoryOrderNo=<%= factoryOrder.entryNo.ToString() %>"><img src="images/button_assist.gif" border="0" width="12" height="13"></a></td>
												</TR>
											</table>
										</td>
