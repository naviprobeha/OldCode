...
namespace WebAdmin
{
	...
	/// </summary>
	public class shippingCustomerLineOrders : System.Web.UI.Page
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			activeLineOrders = lineOrders.getActiveCustomerDataSet(database, this.currentShippingCustomer.no, fromDate, toDate);
