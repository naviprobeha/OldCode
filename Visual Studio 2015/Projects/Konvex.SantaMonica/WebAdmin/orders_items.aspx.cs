...
namespace Navipro.SantaMonica.WebAdmin
{
	...
	/// </summary>
	public class orders_items : System.Web.UI.Page
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			{
				billToCustomer = customers.getEntry(database, currentShipOrder.organizationNo, currentShipOrder.billToCustomerNo);
			}
			else
			{
