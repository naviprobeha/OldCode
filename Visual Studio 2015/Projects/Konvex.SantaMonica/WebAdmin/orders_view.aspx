<%@ Page language="c#" Codebehind="orders_view.aspx.cs" AutoEventWireup="false" Inherits="Navipro.SantaMonica.WebAdmin.orders_view" %>
...
<HTML>
	<HEAD>
		...
		function addItem()
		{
			...
			document.thisform.action = "orders_view.aspx";
										...
										<td class="interaction" valign="top" width="250">
											<table cellspacing="0" cellpadding="0" width="100%" border="0">
												...
												<tr>
													...
													<td class="interaction" width="90%" nowrap><a href="customers_view.aspx?organizationNo=<%= currentShipOrder.organizationNo %>&customerNo=<%= currentShipOrder.customerNo %>"><img src="images/button_assist.gif" border="0" width="12" height="13"></a></td>
												</tr>
											</table>
										</td>
										<td class="interaction" valign="top">
