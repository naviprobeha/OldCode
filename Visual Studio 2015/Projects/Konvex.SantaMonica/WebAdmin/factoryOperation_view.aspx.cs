...
namespace WebAdmin
{
	...
	/// </summary>
	public class factoryOperation_view : System.Web.UI.Page
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			{
				currentLineJournal.factoryConfirmedWaitTime = currentOperator.userId;
			...
			if (Request["command"] == "reportService")
			{
				...
				if (container != null)
				{
					container.reportService(database, 1, currentOperator.userId, 1, currentLineJournal.arrivalFactoryCode);
					Response.Redirect("factoryOperation_view.aspx?parentPage="+Request["parentPage"]+"&lineJournalNo="+currentLineJournal.entryNo);
				}
			}
