...
namespace WebAdmin
{
	...
	/// </summary>
	public class linejournals : System.Web.UI.Page
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			if (currentOrganization.allowLineOrderSupervision)
			{
				if (organizationCode != "")
				{
					activeLineJournals = lineJournals.getActiveDataSet(database, Request["factory"], organizationCode, fromDate, toDate);
				}
				else
				{
					activeLineJournals = lineJournals.getActiveDataSet(database, Request["factory"], fromDate, toDate);
				}
			}
			else
			{
				activeLineJournals = lineJournals.getActiveDataSet(database, Request["factory"], currentOrganization.no, fromDate, toDate);
			}
