...
namespace Navipro.SmartInventory
{
    ...
    public class DataPickLine : ServiceArgument
    {
        ...
        public void save()
        {
            ...
            try
            {
                ...
                if (!dataReader.Read())
                {
                    ...
                    smartDatabase.nonQuery("INSERT INTO pickLine (documentNo, docLineNo, binCode, brand, itemNo, variantCode, description, description2, totalQty, quantity, pickedQty, placeBinCode, picked, placed, totalCount, action, inventory) VALUES ('" + _documentNo + "', '" + _lineNo + "', '" + _binCode + "', '" + _brand + "', '" + _itemNo + "', '" + _variantCode + "', '" + _description + "', '" + _description2 + "',  '" + totalQty.ToString().Replace(",",".") + "', '" + quantity.ToString().Replace(",", ".") + "', '" + pickedQty.ToString().Replace(",",".") + "', '" + _placeBinCode + "', '" + pickedVal + "', '" + placedVal + "', '" + _count + "', '" + _action + "', '" + _inventory + "')");
                }
                else
                {
                    ...
                    smartDatabase.nonQuery("UPDATE pickLine SET binCode = '" + _binCode + "', brand = '" + _brand + "', itemNo = '" + _itemNo + "', variantCode = '" + _variantCode + "', description = '" + _description + "', description2 = '" + _description2 + "', totalQty = '" + totalQty.ToString().Replace(",",".") + "', quantity = '" + _quantity.ToString().Replace(",", ".") + "', pickedQty = '" + _pickedQty.ToString().Replace(",",".") + "', placeBinCode = '" + _placeBinCode + "', picked = '" + pickedVal + "', placed = '" + placedVal + "', totalCount = '" + _count + "', action = '" + _action + "', inventory = '" + _inventory + "' WHERE documentNo = '" + _documentNo + "' AND docLineNo = '" + _lineNo + "'");
                }
                dataReader.Close();
                dataReader.Dispose();
        ...
        private void fromDataReader(SqlCeDataReader dataReader)
        {
            ...
            //this._totalQty = dataReader.GetFloat(8);
            //this._quantity = dataReader.GetFloat(9);
            //this._pickedQty = dataReader.GetFloat(10);
            ...
            this._inventory = float.Parse(dataReader.GetValue(16).ToString());            
            //this._inventory = dataReader.GetFloat(16);
        }
        ...
        private void fromDataRow(DataRow dataRow)
        {
            ...
            this._inventory = float.Parse(dataRow.ItemArray.GetValue(16).ToString());
        }
        ...
        public static void fromDOM(XmlElement pickLinesElement, SmartDatabase smartDatabase)
        {
            ...
            while (i < pickLineNodeList.Count)
            {
                ...
                if (pickLineElement.SelectSingleNode("inventory").FirstChild != null) pickLine.inventory = float.Parse(pickLineElement.SelectSingleNode("inventory").FirstChild.Value);
        ...
        public XmlElement toDOM(XmlDocument xmlDocumentContext)
        {
            ...
            lineElement.SetAttribute("binCode", _binCode.ToString()); // TEST
