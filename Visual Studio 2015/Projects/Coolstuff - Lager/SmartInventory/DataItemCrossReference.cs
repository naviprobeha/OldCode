...
namespace Navipro.SmartInventory
{
    ...
    /// </summary>
    public class DataItemCrossReference : ServiceArgument
    {
        ...
        public static void fromDOM2(XmlElement pickLineElement, SmartDatabase smartDatabase, DataReceiptLine dataReceiptLine)
        {
            ...
            while (i < itemCrossRefsNodeList.Count)
            {
                ...
                DataItemCrossReference dataItemCrossRef = new DataItemCrossReference(smartDatabase);
                dataItemCrossRef.documentNo = dataReceiptLine.documentNo;
                dataItemCrossRef.itemNo = dataReceiptLine.itemNo;
                dataItemCrossRef.variantCode = dataReceiptLine.variantCode;
                dataItemCrossRef.unitOfMeasureCode = "";
                dataItemCrossRef.crossReferenceCode = crossReferenceCode;
                dataItemCrossRef.save();
        ...
        {
            XmlElement docElement = xmlDocumentContext.CreateElement("itemCrossReference");

            XmlElement crossRefNoElement = xmlDocumentContext.CreateElement("crossReferenceNo");
            XmlText crossRefNoText = xmlDocumentContext.CreateTextNode(_crossReferenceCode);
            crossRefNoElement.AppendChild(crossRefNoText);

            docElement.AppendChild(crossRefNoElement);
