...
namespace Navipro.SmartInventory
{
    ...
    public class ServiceResponse
    {
        ...
        public ServiceResponse(XmlElement serviceResponseElement, Logger logger)
        {
            this.logger = logger;
            _hasErrors = false;
            fromDOM(serviceResponseElement);
        }
        ...
        public void fromDOM(XmlElement serviceResponseElement)
        {
