<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="expert.aspx.cs" Inherits="Navipro.Cashjet.Dashboard._Expert" %>
...
<head id="Head1" runat="server">
		...
		<title>Cashjet Dashboard (Expert)</title>
</head>
<body>
	<div id="topbar">
		<div id="title">Cashjet Dashboard (Expert)</div>
	</div>
            ...
            <ul class="pageitem">
                <li class="select">
                    <asp:DropDownList ID="pricesInclVatBox" runat="server" AutoPostBack="true">
                        <asp:ListItem Value="0">Exkl. moms</asp:ListItem>
                        <asp:ListItem Value="1">Inkl. moms</asp:ListItem>
                    </asp:DropDownList>
                    <span class="arrow"></span>
                </li>
            </ul>
			        ...
			        <li class="textbox">
			            <div>
			                ...
			                <div style="float: left; width: 100%;">
			                    ...
			                    <div style="float: right;"><%#DataBinder.Eval(Container.DataItem, "lastPostedJournalEndDate", "{0:c}")%></div>
			                </div>				                			                
			            </div>
