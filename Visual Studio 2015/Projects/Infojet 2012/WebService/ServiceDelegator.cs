...
namespace Navipro.Infojet.WebService
{
	...
	public class ServiceDelegator
	{
        ...
        {
            bool hasDec = xmlDocument.FirstChild.NodeType == XmlNodeType.XmlDeclaration;
            if (!hasDec)
            {
                XmlDeclaration declaration = xmlDocument.CreateXmlDeclaration("1.0", "ISO-8859-1", null);
                xmlDocument.InsertBefore(declaration, xmlDocument.FirstChild);
            }
