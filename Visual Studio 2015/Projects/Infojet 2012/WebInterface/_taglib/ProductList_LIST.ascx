...
<asp:panel runat="server" ID="itemFilterForm" CssClass="itemFilterForm">
    <div class="itemListHeader" style="float: left; width: 790px;">
        <div style="float: left; padding: 5px; width: 250px;" class="middle">
            <asp:CheckBox runat="server" ID="showInventoryOnly" AutoPostBack="true"/> <asp:Label runat="server" ID="showInventoryOnlyLabel" Height="20"></asp:Label><br />
            ...
            <asp:CheckBox runat="server" ID="showItemNo" AutoPostBack="true"/> <asp:Label runat="server" ID="showItemNoLabel" Height="20"></asp:Label>
        </div>
...
<asp:GridView ID="itemListGrid" runat="server" AutoGenerateColumns="false" 
    Width="790px" BorderWidth="0px" onrowdatabound="itemListGrid_RowDataBound" OnRowCommand="productList_buy">
