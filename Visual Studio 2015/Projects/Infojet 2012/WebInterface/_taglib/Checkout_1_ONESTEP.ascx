<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Checkout_1_ONESTEP.ascx.cs" Inherits="Navipro.Infojet.WebInterface._taglib.Checkout_1_ONESTEP" %>
...
<div class="pane"> 
    <div>
        ...
        <asp:RadioButtonList ID="shipmentMethodList" runat="server" AutoPostBack="true" DataTextField="description" DataValueField="code" OnSelectedIndexChanged="shipmentMethodList_SelectedIndexChanged"></asp:RadioButtonList><br />
    ...
    <div>
        ...
        <asp:RadioButtonList ID="paymentMethodList" runat="server" AutoPostBack="true" DataTextField="description" DataValueField="code" OnSelectedIndexChanged="paymentMethodList_SelectedIndexChanged"></asp:RadioButtonList><br />
