...
namespace Navipro.Infojet.Lib
{
	...
	public class WebUserAccount : ServiceArgument
	{
        ...
        public string billToCompanyName2;
		...
		private void readData(SqlDataReader dataReader)
		{
            ...
            if (dataReader.GetInt32(31) == 0) allowOrdering = true;

            companyName2 = dataReader.GetValue(32).ToString();
            billToCompanyName2 = dataReader.GetValue(33).ToString();

            pricesInclVAT = int.Parse(dataReader.GetValue(34).ToString());
		}
        ...
        public System.Xml.XmlElement toDOM(System.Xml.XmlDocument xmlDoc)
        {
            ...
            fieldElement = xmlDoc.CreateElement("languageCode");
            fieldElement.AppendChild(xmlDoc.CreateTextNode(this.languageCode));
            containerElement.AppendChild(fieldElement);
