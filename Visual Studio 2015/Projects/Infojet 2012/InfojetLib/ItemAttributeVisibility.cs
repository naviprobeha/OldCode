...
namespace Navipro.Infojet.Lib
{
	...
	public class ItemAttributeVisibility
	{
		...
		{
            DatabaseQuery databaseQuery = database.prepare("SELECT [Web Site Code], [Item Attribute Code], [Web Item List_Info Code], [Web Text Constant Code], [Visible] FROM [" + database.getTableName("Web Item Attribute Visibility") + "] WHERE [Web Site Code] = @webSiteCode AND [Item Attribute Code] = @itemAttributeCode AND [Web Item List_Info Code] = @webItemListInfoCode");
