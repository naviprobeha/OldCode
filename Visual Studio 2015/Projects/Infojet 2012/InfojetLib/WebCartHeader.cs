			...
			while (i < _webCartLinesDataSet.Tables[0].Rows.Count)
			{
                ...
                while (k < cartConfigLineDataSet.Tables[0].Rows.Count)
                {
                    ...
                    if (webCartConfigLine.visible)
                    {
                        ...
                        XmlElement lineAmountElement = xmlDoc.CreateElement("lineAmount");
                        lineAmountElement.AppendChild(xmlDoc.CreateTextNode(webCartConfigLine.lineAmount.ToString()));
                        configLineElement.AppendChild(lineAmountElement);
