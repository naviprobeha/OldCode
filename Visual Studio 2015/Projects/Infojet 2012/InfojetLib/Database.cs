...
namespace Navipro.Infojet.Lib
{
	...
	public class Database
	{
        ...
        public string getInventoryTableName(WebSite webSite, string tableName)
        {
            if (webSite.inventoryCompanyName != "") return webSite.inventoryCompanyName.Replace(".", "_") + "$" + tableName;
