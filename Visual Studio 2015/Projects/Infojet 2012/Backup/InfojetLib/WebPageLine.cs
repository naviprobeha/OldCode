...
namespace Navipro.Infojet.Lib
{
	...
	/// </summary>
	public class WebPageLine : ServiceArgument
	{
        ...
        {
            return getText(infojetContext.languageCode);
        }
        ...
        public string getText(string languageCode)
        {
            ...
            DataSet dataSet = webPageLineTexts.getDataSet(this, languageCode, this.versionNo);
        ...
        public string getContent()
        {
            ...
            {
                return translateShortCodes(getText());
            }
        }
        ...
        private string encodeAssets(string text)
        {           
            text = text.Replace("\"_assets/", "\"/_assets/");
            text = text.Replace("(_assets/", "(/_assets/");
            text = text.Replace("\"../_assets/", "\"/_assets/");
            text = text.Replace("\"../../_assets/", "\"/_assets/");
            text = text.Replace("\"../../../_assets/", "\"/_assets/");
        ...
        public string translateShortCodes(string text)
        {
            while (text.IndexOf("$[") >= 0)
            {
                string preString = text.Substring(0, text.IndexOf("$["));
                ...
                if (tempString.IndexOf("]") >= 0)
                {
                    string shortCode = tempString.Substring(0, tempString.IndexOf("]"));
                    string postString = tempString.Substring(tempString.IndexOf("]") + 1);
                    text = preString + infojetContext.translate(shortCode) + postString;
                }
        ...
        {
            XmlElement webPageLineElement = xmlDoc.CreateElement("webPageLine");
            ...
            webPageLineElement.AppendChild(webSiteCodeElement);

            XmlElement webPageCodeElement = xmlDoc.CreateElement("webPageCode");
            webPageCodeElement.AppendChild(xmlDoc.CreateTextNode(webPageCode));
            webPageLineElement.AppendChild(webPageCodeElement);

            XmlElement typeElement = xmlDoc.CreateElement("type");
            typeElement.AppendChild(xmlDoc.CreateTextNode(type.ToString()));
            webPageLineElement.AppendChild(typeElement);

            XmlElement codeElement = xmlDoc.CreateElement("code");
            codeElement.AppendChild(xmlDoc.CreateTextNode(code));
            webPageLineElement.AppendChild(codeElement);

            XmlElement webTypeCodeElement = xmlDoc.CreateElement("webTypeCode");
            webTypeCodeElement.AppendChild(xmlDoc.CreateTextNode(webTypeCode));
            webPageLineElement.AppendChild(webTypeCodeElement);

            XmlElement sortOrderElement = xmlDoc.CreateElement("sortOrder");
            sortOrderElement.AppendChild(xmlDoc.CreateTextNode(sortOrder.ToString()));
            webPageLineElement.AppendChild(sortOrderElement);

            return webPageLineElement;
        }
