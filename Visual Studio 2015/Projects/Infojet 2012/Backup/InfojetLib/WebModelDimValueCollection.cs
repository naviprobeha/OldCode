            ...
            while (i < Count)
            {
                ...
                while (j < webModelVertDim.subLevelValues.Count)
                {
                    ...
                    if (webModelVariant != null)
                    {
                        ...
                        ItemInfo itemInfo = webModel.getVariantInventory(webModelHorizDim);
                        if (itemInfo != null)
                        {
                            webModelHorizDim.inventory = itemInfo.inventory;

                            webModelHorizDim.inventoryText = webModel.getInventoryText(itemInfo.inventory);
                        }
                    }
