...
{
    public partial class ProductCategory_LITTERAL : System.Web.UI.UserControl, InfojetUserControl
    {
        private WebPageLine webPageLine;
        protected WebItemCategory webItemCategory;

        protected void Page_Load(object sender, EventArgs e)
        {
            Navipro.Infojet.Lib.Infojet infojet = new Navipro.Infojet.Lib.Infojet();
            webItemCategory = new WebItemCategory(infojet);
