...
{
    public partial class HistoryOrderList_STANDARD : System.Web.UI.UserControl, InfojetUserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            historyOrderRepeater.DataSource = customerHistory.getOrderHistory(pageNo);
            historyOrderRepeater.DataBind();
