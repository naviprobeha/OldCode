<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Cart_GENERAL.ascx.cs" Inherits="Navipro.Infojet.WebInterface._taglib.Cart_GENERAL" %>
<%@ Register TagPrefix="Infojet" TagName="Translate" src="Translate.ascx" %>

<%
    cartItemCollection = webCart.getCartLines(webPageLine);
