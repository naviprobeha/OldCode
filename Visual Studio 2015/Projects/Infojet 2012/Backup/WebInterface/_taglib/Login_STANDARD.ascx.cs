...
namespace Navipro.Infojet.WebInterface._taglib
{
    public partial class Login_STANDARD : System.Web.UI.UserControl, InfojetUserControl
    {
        ...
        protected void Login1_Authenticate(object sender, AuthenticateEventArgs e)
        {
            ...
            {
                Panel loginPanel = ((Panel)login.FindControl("loginPanel"));
                if (loginPanel != null)
                {
                    Label wrongPasswordLabel = ((Label)loginPanel.FindControl("wrongPasswordLabel"));
                    if (wrongPasswordLabel != null)
                    {
                        wrongPasswordLabel.Text = infojet.translate("WRONG PASSWORD");
