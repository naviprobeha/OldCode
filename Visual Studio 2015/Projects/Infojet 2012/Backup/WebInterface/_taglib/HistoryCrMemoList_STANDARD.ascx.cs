...
{
    public partial class HistoryCrMemoList_STANDARD : System.Web.UI.UserControl, InfojetUserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            historyCrMemoRepeater.DataSource = customerHistory.getCrMemoHistory(pageNo);
            historyCrMemoRepeater.DataBind();
