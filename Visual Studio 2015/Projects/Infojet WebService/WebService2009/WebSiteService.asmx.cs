...
namespace Navipro.Infojet.WebService
{
    ...
    public class WebSiteService : System.Web.Services.WebService
    {
        ...
        [WebMethod(EnableSession = true)]
        public NavigationItemCollection getMenuItems(string webSiteCode, string code, string currentWebPageCode, string webUserAccountNo)
        {
            Global.init(webSiteCode);
            ...
            NavigationItemCollection navigationItemCollection = webMenu.getMenuItems(infojetContext, webUserAccount);
