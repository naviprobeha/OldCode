...
namespace Navipro.Infojet.ServiceRequest {
    ...
    public partial class InfojetServiceRequest : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        public InfojetServiceRequest() {
            this.Url = global::WebServiceProxy.Properties.Settings.Default.WebServiceProxy_serviceRequest_InfojetServiceRequest;
        ...
        /// <remarks/>
        public void performserviceAsync(string method, string secret, string xmlDoc) {
            this.performserviceAsync(method, secret, xmlDoc, null);
        }
        
        /// <remarks/>
        public void performserviceAsync(string method, string secret, string xmlDoc, object userState) {
