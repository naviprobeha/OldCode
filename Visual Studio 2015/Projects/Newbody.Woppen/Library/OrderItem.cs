...
namespace Navipro.Newbody.Woppen.Library
{
    ...
    public class OrderItem
    {
        ...
        private float _quantityPackages;
        ...
        public float quantityPackages
        {
            get
            {
                return _quantityPackages;
            }
            set
            {
                _quantityPackages = value;
            }
        }
        ...
        public string formatedQuantityPackages
        {
            get
            {
                if (_quantityPackages > 0) return _quantityPackages.ToString();
                return "";
            }
        }
