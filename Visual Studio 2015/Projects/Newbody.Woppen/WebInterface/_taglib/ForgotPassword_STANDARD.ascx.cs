...
namespace Navipro.Infojet.WebInterface._taglib
{
    public partial class ForgotPassword_STANDARD : System.Web.UI.UserControl, InfojetUserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            submitBtn.Text = infojet.translate("ORDER PASSWORD");
        ...
        void submitBtn_Click(object sender, EventArgs e)
        {
            ...
            {
                webLogin.performUserAccountCheck(infojet, emailBox.Text);

                WebUserAccounts webUserAccounts = new WebUserAccounts(infojet.systemDatabase);

                WebUserAccount webUserAccount = webUserAccounts.findUserAccount(emailBox.Text);
                if (webUserAccount != null)
                {
                    //webUserAccount.sendUserCredentialsByMail(infojet);
                    ApplicationServerConnection appServerConnection = new ApplicationServerConnection(infojet, new ServiceRequest(infojet, "forgotPassword", webUserAccount));
