...
{
    public partial class UserDefined_INFODETAILS : System.Web.UI.UserControl, InfojetUserControl
    {
        protected WebPageLine webPageLine;
        protected Navipro.Infojet.Lib.Infojet infojet;

        protected float grandTotalQuantity;
        protected float grantTotalPackages;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            salesIdList.applySalesIdSentLines(infojet);
            salesIdList.calcSentAmount2(out grandTotalQuantity, out grantTotalPackages, out grandTotalAmount, out totalProfit);
            //totalProfit = grandTotalQuantity * salesIdSetup.unitProfitInclVat;
