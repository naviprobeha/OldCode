...
{
    public partial class HistoryCustomerLedger_STANDARD : System.Web.UI.UserControl, InfojetUserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            historyCustomerLedger.DataSource = customerHistory.getCustomerLedgerInfo();
            historyCustomerLedger.DataBind();
        }
