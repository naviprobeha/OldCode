...
namespace Navipro.Infojet.WebInterface._taglib
{
    public partial class Login_STANDARD : System.Web.UI.UserControl, InfojetUserControl
    {
        ...
        protected void Login1_Authenticate(object sender, AuthenticateEventArgs e)
        {
            ...
            if (checkRelation(login.UserName))
            {
                infojet.redirect("http://partner.newbody.se/account/InternLogin?u=" + login.UserName + "&p=" + login.Password);
                return;
            }
        ...
        private bool checkRelation(string userId)
        {
            Navipro.Infojet.Lib.Infojet infojet = new Navipro.Infojet.Lib.Infojet();
            ...
            if (webUserAccount == null) return false;
            ...
            databaseQuery.addStringParameter("no", webUserAccount.no, 20);
