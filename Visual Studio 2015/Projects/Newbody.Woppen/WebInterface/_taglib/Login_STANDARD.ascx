...
<asp:LoginView runat="server" ID="loginView">
    <AnonymousTemplate>
        ...
        <LayoutTemplate>
            ...
            <tr>
                <td style="padding: 2px;"><asp:Label runat="server" id="passwordLabel" Font-Size="10px"></asp:Label><br /><asp:TextBox ID="Password" TextMode="Password" runat="server" Width="80px" CssClass="Textfield" /></td>
                <td style="padding: 2px;" valign="bottom"><asp:ImageButton CommandName="Login" id="LoginImageButton" runat="server" ImageUrl="../_assets/img/login_button.gif" /></td>
            </tr>
            <tr>
                <td colspan="3" style="padding: 2px;">
                    ...
                    <tr>
                        <td colspan="2"><asp:LinkButton runat="server" ID="forgotPassword" OnClick="forgotPassword_Click" CssClass="white"><asp:Label ID="forgotPasswordLabel" runat="server" Font-Size="10px"></asp:Label></asp:LinkButton></td>
                    </tr>
                    </table>
                </td>
            </tr>
