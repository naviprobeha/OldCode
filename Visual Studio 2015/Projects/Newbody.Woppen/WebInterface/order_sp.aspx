<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="order_sp.aspx.cs" ValidateRequest="false" Inherits="Navipro.Infojet.WebInterface.order_sp" %>
...
<body>
    ...
    <div id="page">
        ...
        <div id="body" style="float: left;">
            <div id="bodyLeft" style="float:left; width: 244px; height: 470px; background-color: #f5f5f5; border: #cecfc6 1px solid; padding-left: 2px;"><Infojet:Content id="content2" runat="server" part="topLeft"/></div>
	        <div id="main" style="float: left; width: 500px; padding-left: 2px; padding-right: 2px;"><Infojet:Content id="content1" runat="server" part="body"/></div>
            <div id="bodyRight" style="float:left; width: 244px; height: 470px; background-color: #f5f5f5; border: #cecfc6 1px solid; padding-left: 2px;"><Infojet:Content id="content3" runat="server" part="topRight"/></div>
        </div>
