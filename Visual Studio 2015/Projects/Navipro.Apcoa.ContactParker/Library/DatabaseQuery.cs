...
namespace Navipro.Apcoa.ContractParker.Library
{
    ...
    public class DatabaseQuery
    {
        ...
        public void addImageParameter(string name, byte[] byteArray)
        {
            SqlParameter sqlParam = new SqlParameter(name, SqlDbType.Image, byteArray.Length);
            sqlParam.Value = byteArray;
