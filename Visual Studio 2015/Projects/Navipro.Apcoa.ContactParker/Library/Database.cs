...
namespace Navipro.Apcoa.ContractParker.Library
{
    /// <summary>
    ...
    public class Database
    {
        ...
        {
            if ((companyName == null) || (companyName == "")) companyName = configuration.companyName;
            if ((companyName != null) && (companyName != "")) return companyName + "$" + tableName;
        ...
        public string convertTableName(string tableName)
        {
            if (configuration.nav2013mode)
            {
                if (tableName == "Country") tableName = "Country_Region";
            }
