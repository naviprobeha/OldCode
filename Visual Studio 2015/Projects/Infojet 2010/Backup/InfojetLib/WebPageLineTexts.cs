...
namespace Navipro.Infojet.Lib
{
	...
	public class WebPageLineTexts
	{
        ...
        public void delete(WebPageLine webPageLine, string languageCode, int versionNo)
        {
            database.nonQuery("DELETE FROM [" + database.getTableName("Web Page Line Text") + "] WHERE [Web Site Code] = '" + webPageLine.webSiteCode + "' AND [Web Page Code] = '" + webPageLine.webPageCode + "' AND [Web Page Line No_] = '" + webPageLine.lineNo + "' AND [Language Code] = '" + languageCode + "' AND [Version No_] = '" + versionNo + "'");
        }
