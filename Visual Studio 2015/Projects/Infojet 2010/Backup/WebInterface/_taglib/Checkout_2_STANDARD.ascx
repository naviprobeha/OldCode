...
<table class="tableView" style="width: 100%">
    ...
    <ItemTemplate>
        <tr>
            ...
            <td class="itemListAltLine" align="right"><div id="cartQuantity_<%#DataBinder.Eval(Container.DataItem, "lineNo")%>" style="float: right; text-align: right;"><%#DataBinder.Eval(Container.DataItem, "quantity")%></div><div id="changeCartQuantity_<%#DataBinder.Eval(Container.DataItem, "lineNo")%>" style="visibility: hidden; float: right;"><asp:textBox Id="quantityBox" Runat="server" Width="40px" Text='<%#DataBinder.Eval(Container.DataItem, "quantity")%>' CssClass="Textfield" /></div></td>
            <td class="itemListAltLine" align="right"><%#DataBinder.Eval(Container.DataItem, "formatedAmount")%></td>
            <td class="itemListAltLine" align="center"><div id="lineButtons_<%#DataBinder.Eval(Container.DataItem, "lineNo")%>"><a href="javascript:changeQuantity(<%#DataBinder.Eval(Container.DataItem, "lineNo")%>)"><Infojet:Translate runat="server" ID="Translate10" code="CHANGE" /></a> | <a href="<%#DataBinder.Eval(Container.DataItem, "removeLink")%>" style="font-size: 10px"><Infojet:Translate runat="server" ID="Translate3" code="REMOVE" /></a></div><div id="changeButton_<%#DataBinder.Eval(Container.DataItem, "lineNo")%>" style="visibility: hidden;"><asp:LinkButton ID="updateQuantity" runat="server" CommandName="update" CommandArgument='<%#DataBinder.Eval(Container.DataItem, "lineNo")%>'><Infojet:Translate ID="update" runat="server" code="SAVE" /></asp:LinkButton></div></td>
        </tr>
    </ItemTemplate>
    ...
    <AlternatingItemTemplate>
        <tr>
            ...
            <td class="itemListLine" align="right"><div id="cartQuantity_<%#DataBinder.Eval(Container.DataItem, "lineNo")%>" style="float: right; text-align: right;"><%#DataBinder.Eval(Container.DataItem, "quantity")%></div><div id="changeCartQuantity_<%#DataBinder.Eval(Container.DataItem, "lineNo")%>" style="visibility: hidden; float: right;"><asp:textBox Id="quantityBox" Runat="server" Width="40px" Text='<%#DataBinder.Eval(Container.DataItem, "quantity")%>' CssClass="Textfield" /></div></td>
            <td class="itemListLine" align="right"><%#DataBinder.Eval(Container.DataItem, "formatedAmount")%></td>
            <td class="itemListLine" align="center"><div id="lineButtons_<%#DataBinder.Eval(Container.DataItem, "lineNo")%>"><a href="javascript:changeQuantity(<%#DataBinder.Eval(Container.DataItem, "lineNo")%>)"><Infojet:Translate runat="server" ID="Translate10" code="CHANGE" /></a> | <a href="<%#DataBinder.Eval(Container.DataItem, "removeLink")%>" style="font-size: 10px"><Infojet:Translate runat="server" ID="Translate3" code="REMOVE" /></a></div><div id="changeButton_<%#DataBinder.Eval(Container.DataItem, "lineNo")%>" style="visibility: hidden;"><asp:LinkButton ID="updateQuantity" runat="server" CommandName="update" CommandArgument='<%#DataBinder.Eval(Container.DataItem, "lineNo")%>'><Infojet:Translate ID="update" runat="server" code="SAVE" /></asp:LinkButton></div></td>
        </tr>
    </AlternatingItemTemplate>    
