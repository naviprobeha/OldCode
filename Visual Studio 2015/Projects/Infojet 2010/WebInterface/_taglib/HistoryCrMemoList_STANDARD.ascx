...
<HeaderTemplate>
    ...
    <tr>
        <th><Infojet:Translate runat="server" ID="no" code="NO_" /></th>
...
<ItemTemplate>
    <tr>
        ...
        <td style="text-align: center;"><a href="<%#DataBinder.Eval(Container.DataItem, "pdfLink")%>"><Infojet:Translate runat="server" ID="Translate1" code="PDF" /></a></td>        
