...
{
    public partial class HistoryInvoiceList_STANDARD : System.Web.UI.UserControl, InfojetUserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            historyInvoiceRepeater.DataSource = customerHistory.getInvoiceHistory(pageNo);
            historyInvoiceRepeater.DataBind();
