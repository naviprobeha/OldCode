    ...
    public class EditorControl : ServiceArgument
    {
        ...
        public void Render(StringWriter output)
        {
            if (!isPostBack())
            {
                ...
                output.WriteLine("<script type=\"text/javascript\" src=\""+infojetContext.webSite.location+"_assets/editor/jscripts/tiny_mce/tiny_mce.js\"></script>");
                ...
                output.WriteLine("content_css : \""+infojetContext.webSite.location+"_assets/css/visuals.css\" ");
