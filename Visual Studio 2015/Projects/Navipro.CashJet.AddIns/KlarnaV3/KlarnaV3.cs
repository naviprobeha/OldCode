...
namespace Navipro.CashJet.AddIns
{
    public class KlarnaV3Handler
    {
        ...
        public string CreateHPPSession(string sessionId)
        {
            ...
            JObject sessionDefinition = JObject.FromObject(new
            {
                ...
                payment_session_url = baseUrl+ "payments/v1/sessions/"+sessionId
            });
        ...
        public bool CreateOrder(string authorizationToken, decimal orderAmount, decimal orderTaxAmount, string currencyCode, out string orderToken)
        {
            int orderAmountInt = (int)(orderAmount * 100);
            int orderTaxAmountInt = (int)(orderTaxAmount * 100);
