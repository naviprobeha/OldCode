...
namespace ESC_POS_USB_NET.Printer
{
    public class Printer : IPrinter
    {
        ...
        public void PrintDocument()
        {
            ...
            Printer.SendBytesToPrinter(_buffer);
        }
        ...
        public void InitializePrint()
        {
            ...
            Printer.SendBytesToPrinter(_command.InitializePrint.Initialize());
        }
        ...
        public static void SendBytesToPrinter(byte[] buffer)
        {
            TcpClient client = new TcpClient();
            client.Connect("192.168.120.105", 91078);
