...
namespace SmartOrder
{
    ...
    public class DataItemCategory
    {
        ...
        public DataItemCategory(XmlElement productGroupElement, SmartDatabase smartDatabase, bool updateDb)
        {
        ...
        public DataItemCategory(string code)
        {
            codeValue = code;
        }

        public DataItemCategory(string code, SmartDatabase smartDatabase)
        {
            codeValue = code;
            this.smartDatabase = smartDatabase;
            getFromDb();
