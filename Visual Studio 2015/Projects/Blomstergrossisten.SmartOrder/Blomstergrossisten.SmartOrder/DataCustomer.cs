...
namespace SmartOrder
{
    ...
    public class DataCustomer
    {
        ...
        public void fromDOM(XmlElement recordElement)
        {
            ...
            while (i < fields.Count)
            {
                ...
                if (this.updateMethod != "D")
                {
                    ...
                    if (fieldNo.FirstChild.Value.Equals("29")) salesPersonCodeValue = fieldValue;
                    ...
                    //if (fieldNo.FirstChild.Value.Equals("39"))
                        ...
                        //}
                    if (fieldNo.FirstChild.Value.Equals("39")) blockedValue = int.Parse(fieldValue);
                }
                i++;
            }
        }
        ...
        public void commit()
        {
            ...
            if (dataReader.Read())
            {
                ...
                else
                {
                    ...
                    try
                    {
                        smartDatabase.nonQuery("UPDATE customer SET name = '" + nameValue + "', address = '" + addressValue + "', address2 = '" + address2Value + "', zipCode = '" + zipCodeValue + "', city = '" + cityValue + "', priceGroupCode = '" + priceGroupCodeValue + "', blocked = '" + blockedValue + "', customerDiscountGroup = '" + customerDiscountGroupValue + "', salesPersonCode = '" + salesPersonCodeValue + "' WHERE no = '" + noValue + "'");
                    }
            ...
            else
            {
                ...
                try
                {
                    smartDatabase.nonQuery("INSERT INTO customer (no, name, address, address2, zipCode, city, priceGroupCode, blocked, customerDiscountGroup, salesPersonCode) VALUES ('" + noValue + "','" + nameValue + "','" + addressValue + "','" + address2Value + "','" + zipCodeValue + "','" + cityValue + "','" + priceGroupCodeValue + "','" + blockedValue + "','" + customerDiscountGroupValue + "','" + salesPersonCodeValue + "')");
                }
                catch (SqlCeException e)
                {
                    smartDatabase.ShowErrors(e);
        ...
        {
            SqlCeDataReader dataReader = smartDatabase.query("SELECT no, name, address, address2, zipCode, city, priceGroupCode, blocked, customerDiscountGroup, visible, salesPersonCode FROM customer WHERE no = '" + no + "'");
            ...
            if (dataReader.Read())
            {
                try
                {
                    ...
                    this.salesPersonCodeValue = dataReader.GetValue(10).ToString();
                    dataReader.Dispose();
                    return true;
                }
                catch (SqlCeException e)
