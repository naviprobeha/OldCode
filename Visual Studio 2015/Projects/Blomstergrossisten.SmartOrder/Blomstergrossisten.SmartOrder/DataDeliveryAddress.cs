    ...
    public class DataDeliveryAddress
    {
        ...
        public void commit()
        {
            ...
            else
            {
                try
                {
                    smartDatabase.nonQuery("INSERT INTO deliveryAddress (customerNo, code, name, address, address2, zipCode, city, contact) VALUES ('" + customerNoValue + "','" + codeValue + "','" + nameValue + "','" + addressValue + "','" + address2Value + "','" + zipCodeValue + "','" + cityValue + "','" + contactValue + "')");
                }
                catch (SqlCeException e)
                {
                    smartDatabase.ShowErrors(e);
