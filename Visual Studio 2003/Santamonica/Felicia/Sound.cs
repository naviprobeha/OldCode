...
namespace Navipro.SantaMonica.Felicia
{
	...
	public class Sound
	{
		...
		public Sound (int type) 
		{
			if (type == 0)
			{
				soundFileName = "\\Windows\\Alarm4.wav";
			}
			if (type == 1)
			{
				soundFileName = "\\Windows\\default.wav";
			}
			if (type == 2)
			{
				soundFileName = "\\Windows\\ScanOk.wav";
			}
			if (type == 3)
			{
				soundFileName = "\\Windows\\msgbox.wav";
			}
		...
		public Sound(Stream stream) 
		{
			...
			stream.Read(soundBuffer, 0,(int)stream.Length);
		}
